...
class Guest(Base):
    ...
    phone_number = Column(String, nullable=False) #stored as a string so that it can start with 0
...
class Room(Base):
    ...
    status = Column(String, nullable=False) #eg booked,available,maintained
...
class Reservation(Base):
    ...
    payment = relationship("Payment", back_populates="reservations", uselist=False)
